...
python get_chunk_embedding.py --num_chunks 5 --path_data './data/CancerDoc/df_all_CancerDoc.csv' --path_save_X './data/embedding_data/CancerDoc_chunk_X_5.pkl'
python get_chunk_embedding.py --num_chunks 10 --path_data './data/CancerDoc/df_all_CancerDoc.csv' --path_save_X './data/embedding_data/CancerDoc_chunk_X_10.pkl'
...
python get_chunk_embedding.py --num_chunks 20 --path_data './data/CancerDoc/df_all_CancerDoc.csv' --path_save_X './data/embedding_data/CancerDoc_chunk_X_20.pkl'
