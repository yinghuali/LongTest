...
python get_chunk_embedding.py --num_chunks 10 --path_data './data/20news/df_all_20news.csv' --path_save_X './data/embedding_data/20news_chunk_X_10.pkl'
python get_chunk_embedding.py --num_chunks 15 --path_data './data/20news/df_all_20news.csv' --path_save_X './data/embedding_data/20news_chunk_X_15.pkl'
python get_chunk_embedding.py --num_chunks 20 --path_data './data/20news/df_all_20news.csv' --path_save_X './data/embedding_data/20news_chunk_X_20.pkl'
