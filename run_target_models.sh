...
python get_target_DNN.py --path_file_embedding_X './data/embedding_data/FakeNews_file_X.pkl' --path_file_embedding_y './data/embedding_data/FakeNews_file_y.pkl' --path_save_model './target_models/FakeNews_MiniLM-L6-v2-dnn.h5' --epochs 3
python get_target_tabnet.py --path_file_embedding_X './data/embedding_data/FakeNews_file_X.pkl' --path_file_embedding_y './data/embedding_data/FakeNews_file_y.pkl' --path_save_model './target_models/FakeNews_MiniLM-L6-v2-tabnet.pth' --epochs 10
